...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('accel_qpps', default_value='65535'),  # near-instant acceleration (no ramp)
        ...
        DeclareLaunchArgument('m1_pid_qpps', default_value='26070'),
        DeclareLaunchArgument('m2_pid_p', default_value='2.63543'),
        DeclareLaunchArgument('m2_pid_i', default_value='0.18177'),
        DeclareLaunchArgument('m2_pid_d', default_value='0.0'),
        DeclareLaunchArgument('m2_pid_qpps', default_value='25410'),
        DeclareLaunchArgument('odom_publish_rate', default_value='20'),
    ...
    node_params = [
        ...
        {'m1_pid_p': LaunchConfiguration('m1_pid_p')},
        {'m1_pid_i': LaunchConfiguration('m1_pid_i')},
        {'m1_pid_d': LaunchConfiguration('m1_pid_d')},
        {'m1_pid_qpps': LaunchConfiguration('m1_pid_qpps')},
        {'m2_pid_p': LaunchConfiguration('m2_pid_p')},
        {'m2_pid_i': LaunchConfiguration('m2_pid_i')},
        {'m2_pid_d': LaunchConfiguration('m2_pid_d')},
        {'m2_pid_qpps': LaunchConfiguration('m2_pid_qpps')},
