...
class RoboclawNode(Node):
    ...
    def __init__(self):
        ...
        # Measured effective counts per wheel rev for 50:1 Pololu 37D encoder setup.
        self.declare_parameter('qppr', 7000)
    ...
    def update_odom(self):
        ...
        try:
            ...
            if self.last_enc_left is not None and self.last_enc_right is not None and dt > 0:
                ...
                # Increase covariance to reduce EKF trust in wheel odom during spins.
